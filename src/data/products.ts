...
export interface Product {
  ...
  images: string[];
  /** Transparent PNG for the AR try-on overlay (generated by scripts/remove-bg.mjs) */
  tryOnImage?: string;
  /** GLB/GLTF 3D model for the AR try-on overlay */
  tryOnModel?: string;
  sizes?: string[];
  isNew: boolean;
}
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    tryOnImage: "/try-on-overlays/18k-gold-plated-bracelet.png",
  ...
  },
  {
    ...
    tryOnImage: "/try-on-overlays/italian-charms-bracelet.png",
    tryOnModel: "/try-on-overlays/bracelet.glb",
  ...
  },
  {
    ...
    tryOnImage: "/try-on-overlays/italian-charms-bracelet-gold.png",
    isNew: false,
  },
  {
    id: 9,
